...
.from("slots")
.select("id, starts_at, ends_at, is_booked, bookings(student_name,student_email,note)")
...
return NextResponse.json({ ok: true, weekStart: weekStart.toISOString(), slots: rows });
}